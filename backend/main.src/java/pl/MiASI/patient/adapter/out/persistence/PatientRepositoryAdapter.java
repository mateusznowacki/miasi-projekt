...
public class PatientRepositoryAdapter implements PatientRepository {
    ...
    public void save(Patient patient) {
        ...
        List<MedicalRecordJpaEntity> recs = patient.getMedicalRecords().stream().map(r -> {
            ...
            re.setNotes(r.getNotes()); re.setTestResults(r.getTestResults()); re.setCreatedAt(r.getCreatedAt());
            re.setUpdatedAt(r.getUpdatedAt()); re.setUpdatedBy(r.getUpdatedBy() != null ? r.getUpdatedBy().value() : null);
            return re;
